...
bar {
    ...
    colors {
        ...
        statusline #D0D4DC
        separator  #23262D
        focused_workspace  #2E3440 #88C0D0 #101215
        inactive_workspace #101215 #101215 #2A2E36
        active_workspace   #2A2E36 #2A2E36 #101215
    }
}
...
# Colores de bordes de ventanas
# (Formato: border background text indicator child_border)
client.focused          #88C0D0 #88C0D0 #2E3440 #88C0D0 #88C0D0
client.unfocused        #1E1E1E #1E1E1E #AAAAAA #1E1E1E #1E1E1E
